...
public class ExternalSort<E extends Comparable<E>>
{
    ...
    public ExternalSort( EScanner<E> eScanner ) { this.eScanner = eScanner; }
    ...
    void merge( int n, Iterator<E> in0, Iterator<E> in1, PrintWriter out )
    {
        ...
        while ( e0 != null && e1 != null )
        {
            ...
            // Compare e0 and e1 and write the smaller (or equal) value to the output
            if ( e0.compareTo( e1 ) <= 0 )
            {
                out.println( e0 );
                e0 = next( in0, n, n0++ ); // Get the next element from in0
            }
            else
            {
                out.println( e1 );
                e1 = next( in1, n, n1++ ); // Get the next element from in1
            }
        }
        ...
        // Write out the rest of in0 if it has remaining elements
        while ( e0 != null )
        {
            out.println( e0 );
            e0 = next( in0, n, n0++ );
        ...
        // Write out the rest of in1 if it has remaining elements
        while ( e1 != null )
        {
            out.println( e1 );
            e1 = next( in1, n, n1++ );
