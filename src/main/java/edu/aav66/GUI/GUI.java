...
public class GUI implements UserInterface
{
     ...
     */
    public GUI( String windowTitle ) { this.windowTitle = windowTitle; }
     ...
     */
    public void sendMessage( String message ) { JOptionPane.showMessageDialog( null, message ); }
     ...
     */
    public String getInfo( String prompt ) { return JOptionPane.showInputDialog( prompt ); }
